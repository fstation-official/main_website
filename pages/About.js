    ...
    return (
        <>
            ...
            <div className="grid mt-20 sm:grid-cols-2 bg-gray-90 ">
                ...
                <div>
                    <img className="" src="https://media.giphy.com/media/PI3QGKFN6XZUCMMqJm/giphy.gif" />
