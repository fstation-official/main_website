...
function Contact() {
    return (<>
        ...
        <section className="bg-white py-10 ml-10 lg:py-[120px] overflow-hidden relative z-10">
                    ...
                    <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                        ...
                        "
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="w-full p-3 text-white transition bg-blue-700 border rounded border-primary hover:bg-opacity-90"
                                    >
                                        Send Message
                                    </button>
                                </div>
